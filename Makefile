...
test: ${BUILD_DIR}/bin/radiusd ${BUILD_DIR}/bin/radclient tests.api tests.unit tests.xlat tests.keywords tests.modules tests.auth test.sql_nas_table $(BUILD_DIR)/tests/radiusd-c | build.raddb
